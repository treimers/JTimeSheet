...
JTimeSheet is a desktop application for tracking time spent on projects and tasks.
...
Your data (activities and settings) is stored in a single JSON file. You can set the data file location in **Settings**.
